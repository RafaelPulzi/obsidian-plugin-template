...
## Sugestões para evoluir este template

Você pode expandir esta base adicionando:

- testes automatizados
- i18n
- comandos contextuais
- views customizadas
- integração com metadata cache
- painéis laterais
- modais avançados
- processamento de frontmatter com `FileManager.processFrontMatter`
- integração com canvas, tasks ou graph

---

## Licença

Escolha uma licença compatível com a distribuição que você deseja para o seu plugin.
...
Este template te dá uma base profissional para:

- criar plugins do Obsidian com TypeScript
- testar localmente com segurança
- versionar no GitHub
- gerar releases corretas
- se preparar para publicação oficial como Community Plugin

Se quiser, o próximo passo natural é personalizar este README com:

- o nome real do seu plugin
- a proposta do plugin
- exemplos de uso
- roadmap
